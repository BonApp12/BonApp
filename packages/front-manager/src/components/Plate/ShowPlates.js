                    ...
                    <div className="">
                        ...
                        <div className="w-full px-5">
                            {modalInfo.ingredients?.length === 0 ? (
                                    <>
                                        <span className={'btn btn-primary btn-xs mr-2 rounded-full text-white '}
                                              style={{backgroundColor: '#' + generateHexaColor()}}>Aucun ingrédients renseignés</span>
                                    </>
                                ...
                                modalInfo.ingredients?.map(ingredient => (
                                    <>
                                        <span key={ingredient.id}
                                              className={'btn btn-primary btn-xs mr-2 rounded-full text-white '}
                                              style={{backgroundColor: '#' + generateHexaColor()}}> {ingredient.name}</span>
                                    </>
                                ))}
                        </div>
                    </div>
                    ...
                    <div className="">
                        ...
                        <div className="w-full px-5">
                            {modalInfo.categories?.length === 0 ? (
                                    <>
                                        <span className={'btn btn-primary btn-xs mr-2 rounded-full text-white '}
                                              style={{backgroundColor: '#' + generateHexaColor()}}>Aucunes catégories</span>
                                    </>
                                ...
                                modalInfo.categories?.map(category => (
                                    <>
                                        <span key={category.id}
                                              className={'btn btn-primary btn-xs mr-2 rounded-full text-white '}
                                              style={{backgroundColor: '#' + generateHexaColor()}}> {category.name}</span>
                                    </>
                                ))}
                        </div>
                    </div>
